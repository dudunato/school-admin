		...
		<fieldset id="fieldsetCad" class="fieldsetclass">
			...
			<div style="margin: auto;width: 600px;">
				...
				<fieldset class="fieldsetclass" style="float: left;width: 553px;">
					<legend style="font-size: 13px;padding: 3px;">Horários</legend>
					...
					<label id="sTimelabel" style=" display: block;float: left;margin-left: 54px;width: 90px;">Ínicio*:
						<span style="display: block;">
					...
					<label id="sTimelabel2" style=" display: block;float: left;margin-left: 54px;width: 90px;">Ínicio*:
						<span style="display: block;">
