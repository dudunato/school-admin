...
function switchEdit(n){
	...
	$('#legendCad').text('Editar Grade Horária');
...
function switchCad(){
	clearFields();
	$('#fieldsetCad').hide();
	$('#legendCad').text('Cadastrar Grade Horária');
...
<tiles:putAttribute name="content">
	<div id="panel" class="ui-dialog ui-widget ui-widget-content ui-corner-all  ui-draggable ui-resizable" >
        <span class="panel-title" style="width: 335px;">Grade Horária Alunos Exp.</span>
		
		<fieldset id="fieldsetCad" class="fieldsetclass">
			<legend id="legendCad">Cadastrar Grade Horária</legend>
			...
			<div style="margin: auto;width: 600px;">
				...
				<fieldset class="fieldsetclass" style="float: left;width: 553px;">
					<legend style="font-size: 13px;padding: 3px;">Horário</legend>
					...
					<label id="sTimelabel" style=" display: block;float: left;margin-left: 74px;width: 90px;">Ínicio*:
						<span style="display: block;">
